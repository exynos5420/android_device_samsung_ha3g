...
const int32_t scalerResolutionS5K4H5[] =
{
    1920, 1080, // 16:9
    1440, 1080, // 4:3
    1440,  960, // 3:2
...
const int32_t jpegResolutionS5K4H5[] =
{
    2560, 1920,
    2560, 1440,
    2160, 1440,
...
const uint8_t availableAfModesS5K4H5[] =
{
...
const uint8_t sceneModeOverridesS5K4H5[] =
{
...
const uint8_t availableAeModesS5K4H5[] =
{
...
ExynosCamera2InfoS5K4H5::ExynosCamera2InfoS5K4H5()
{
    sensorW             = 2560;
    sensorH             = 1920;
    sensorRawW          = (2560 + 16);
    sensorRawH          = (1920 + 10);
    numScalerResolution = ARRAY_SIZE(scalerResolutionS5K4H5)/2;
    scalerResolutions   = scalerResolutionS5K4H5;
    numJpegResolution   = ARRAY_SIZE(jpegResolutionS5K4H5)/2;
    jpegResolutions     = jpegResolutionS5K4H5;
    minFocusDistance    = 0.1f;
    focalLength         = 3.1f;
    aperture            = 1.9f;
    fnumber             = 1.9f;
    availableAfModes    = availableAfModesS5K4H5;
    numAvailableAfModes = ARRAY_SIZE(availableAfModesS5K4H5);
    sceneModeOverrides  = sceneModeOverridesS5K4H5;
    numSceneModeOverrides = ARRAY_SIZE(sceneModeOverridesS5K4H5);
    availableAeModes    = availableAeModesS5K4H5;
    numAvailableAeModes = ARRAY_SIZE(availableAeModesS5K4H5);
}
...
const int32_t scalerResolutionS5K6B2[] =
{
    1344,  896, // 3:2
    1280, 1024, // 5:4
    1024, 1024, // 1:1
...
const int32_t jpegResolutionS5K6B2[] =
{
    1392, 1392,
    1392, 1040,
    1392,  928,
...
{
    if (cameraId == 0)
        m_curCameraInfo      = new ExynosCamera2InfoS5K4H5;
    else
