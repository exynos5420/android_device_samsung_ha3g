...
*/
    ...
    {RIL_UNSOL_RESPONSE_NEW_CB_MSG, responseVoid, WAKE_PARTIAL}, // 11000 X
    ...
    {RIL_UNSOL_SIM_PB_READY, responseVoid, WAKE_PARTIAL}, // 11021 X
    {11022, NULL, WAKE_PARTIAL}, // 11022
    {11023, NULL, WAKE_PARTIAL}, // 11023
    {RIL_UNSOL_VE, responseVoid, WAKE_PARTIAL}, // 11024 X
    {11025, NULL, WAKE_PARTIAL}, // 11025
    {RIL_UNSOL_FACTORY_AM, responseVoid, WAKE_PARTIAL}, // 11026 X
    {RIL_UNSOL_IMS_REGISTRATION_STATE_CHANGED, responseVoid, WAKE_PARTIAL}, // 11027 X
    {RIL_UNSOL_MODIFY_CALL, responseVoid, WAKE_PARTIAL}, // 11028 X
    {RIL_UNSOL_SRVCC_HANDOVER, responseVoid, WAKE_PARTIAL}, // 11029 X
    {RIL_UNSOL_CS_FALLBACK, responseVoid, WAKE_PARTIAL}, // 11030 X
    {11031, NULL, WAKE_PARTIAL}, // 11031
    {RIL_UNSOL_VOICE_SYSTEM_ID, responseVoid, WAKE_PARTIAL}, // 11032 X
