...
*/
    {RIL_OEM_UNSOL_RESPONSE_BASE, NULL, WAKE_PARTIAL},
    ...
    {11004, responseVoid, WAKE_PARTIAL}, // 11004
    {11005, responseVoid, WAKE_PARTIAL}, //11005
    {11006, NULL, WAKE_PARTIAL},
    {11007, responseVoid, WAKE_PARTIAL}, // 11007
    ...
    {110011, responseVoid, WAKE_PARTIAL}, // 11011
    {110012, responseInts, WAKE_PARTIAL}, // 11012
    {RIL_UNSOL_SAP, responseVoid, WAKE_PARTIAL}, // 11013
    {11014, NULL, WAKE_PARTIAL},
    {11015, responseVoid, WAKE_PARTIAL}, // 11015
    {11016, responseVoid, WAKE_PARTIAL}, // 11016
    {11017, responseInts, WAKE_PARTIAL}, // 11017
    {11018, responseInts, WAKE_PARTIAL}, // 11018
    {11019, responseVoid, WAKE_PARTIAL}, // 11019
    {RIL_UNSOL_UART, responseVoid, WAKE_PARTIAL}, // 11020
    {RIL_UNSOL_SIM_PB_READY, responseVoid, WAKE_PARTIAL}, // 11021
    {11022, responseVoid, WAKE_PARTIAL}, // 11022
    {11023, responseVoid, WAKE_PARTIAL}, // 11023
    {RIL_UNSOL_VE, responseVoid, WAKE_PARTIAL}, // 11024
    {11025, responseVoid, WAKE_PARTIAL}, // 11025
    ...
    {11031, responseVoid, WAKE_PARTIAL}, // 11031
    ...
    {11036, responseVoid, WAKE_PARTIAL}, // 11036
    {RIL_UNSOL_HYSTERESIS_DCN, responseVoid, WAKE_PARTIAL}, // 11037
    {RIL_UNSOL_CP_POSITION, responseVoid, WAKE_PARTIAL}, // 11038
    {11039, responseVoid, WAKE_PARTIAL}, // 11039
    {11040, responseVoid, WAKE_PARTIAL}, // 11040
    {11041, responseVoid, WAKE_PARTIAL}, // 11041
    {11042, responseVoid, WAKE_PARTIAL}, // 11042
    {RIL_UNSOL_HOME_NETWORK_NOTI, responseVoid, WAKE_PARTIAL}, // 11043
    {11044, responseVoid, WAKE_PARTIAL}, // 11044
    {11045, responseVoid, WAKE_PARTIAL}, // 11045
    {11046, responseVoid, WAKE_PARTIAL}, // 11046
    {11047, responseVoid, WAKE_PARTIAL}, // 11047
    {11048, responseVoid, WAKE_PARTIAL}, // 11048
    {11049, responseVoid, WAKE_PARTIAL}, // 11049
    {11050, responseVoid, WAKE_PARTIAL}, // 11050
    {11051, responseVoid, WAKE_PARTIAL}, // 11051
    {11052, responseVoid, WAKE_PARTIAL}, // 11052
    {11053, responseVoid, WAKE_PARTIAL}, // 11053
    {RIL_UNSOL_STK_CALL_STATUS, responseVoid, WAKE_PARTIAL}, // 11054
    {RIL_UNSOL_ON_SS, responseVoid, WAKE_PARTIAL}, // 11055
    {11056, responseVoid, WAKE_PARTIAL}, // 11056
    {11057, responseVoid, WAKE_PARTIAL}, // 11057
    {11058, responseVoid, WAKE_PARTIAL}, // 11058
    {11059, responseVoid, WAKE_PARTIAL}, // 11059
    {11060, responseVoid, WAKE_PARTIAL}, // 11060
